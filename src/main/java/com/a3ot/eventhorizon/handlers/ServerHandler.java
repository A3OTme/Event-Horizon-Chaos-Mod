...
public class ServerHandler {
    ...
    public static void sendMessage(ServerPlayer player){
        if (!ServerTick.isRun()){
            MutableComponent command = Component.translatable("eventhorizon.message.start_command")
            ...
            MutableComponent message = Component.translatable("eventhorizon.message.ready", command);
